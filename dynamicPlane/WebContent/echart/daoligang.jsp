    ...
    <div class="layui-side-scroll">
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
       ...
       <li class="layui-nav-item"><a href="javascript:;">机场资源图表显示</a>
		...
		<div style="padding: 15px;"><div id="main" style="width:1200px;height:550px;"></div>	
		
	<script type="text/javascript">
		var riqi;
		$.post(
            "../daoligangServletEchart",//访问地址
            {},//携带的参数
            function (data) {
            	riqi = data.date;
                generateChart(data);
	    ...
	    $("#h2").html("20170601至"+riqi+"航班到离港动态统计表");
        ...
        var option = {
        	    ...
        	    dataset: {
        	        source: [
        	            data.datelist,
        	            data.yingdaogangcountList,
        	            data.yingligangcountList,
        	            data.yidaogangcountList,
        	            data.yiligangcountList
        	        ]
        	    },
        	    xAxis: {type: 'category'},
        	    yAxis: {},
