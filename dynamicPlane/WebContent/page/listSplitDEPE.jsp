...
layui.use(['element','table','jquery'], function(){
		  ...
		  table.render({
			  ...
			  cols:[[
				  ...
				  {	field:'sTAT',title:'航班发布状态',width:250,align:'center'},		
				  {	field:'iSTA',title:'航班状态',width:150,align:'center'},
				  {	field:'fRTT',title:'实际起飞时间',width:250,align:'center'}
			  ]],
			  id:"testReload"
		  });
		  var $ = layui.$, active = {
