...
layui.use(['element','table','jquery'], function(){
		  ...
		  table.render({
			  elem:'#page',
			  page:true,
			  url:'../BLLSServletSearch',
			  cols:[[
				  {	field:'fLID',title:'航班标识标签',width:200,sort: true,fixed:'left',align:'center'},				  
				  {	field:'fFID',title:'航班标识',width:250,align:'center'},		
				  {	field:'fATT',title:'航班属性',width:200,align:'center'},
				  {	field:'bTNO',title:'行李提取转盘序号',width:150,align:'center'},
				  {	field:'iD',title:'行李提取转盘唯一标识',width:250,align:'center'},
				  {	field:'cODE',title:'行李提取转盘编号',width:200,align:'center'},				 
				  {	field:'bTAT',title:'行李提取转盘属性',width:200,align:'center'},		  
				  {	field:'eSTR',title:'预计开始使用时间',width:150,align:'center'},
				  {	field:'eEND',title:'预计结束使用时间',width:150,align:'center'},
				  {	field:'rSTR',title:'实际开始使用时间',width:150,align:'center'},		  
				  {	field:'rEND',title:'实际结束使用时间',width:150,align:'center'},
				  {	field:'bTSC',title:'资源所属楼号',width:150,align:'center'}
			  ]],
			  id:"testReload"
		  });
		  var $ = layui.$, active = {
