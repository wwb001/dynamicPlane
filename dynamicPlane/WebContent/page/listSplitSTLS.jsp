...
layui.use(['element','table','jquery'], function(){
		  ...
		  table.render({
			  ...
			  cols:[[
				  ...
				  {	field:'sTNO',title:'机位序号',width:150,align:'center'},		
				  {	field:'cODE',title:'机位编号',width:250,align:'center'},
				  ...
				  {	field:'rEND',title:'实际结束使用时间',width:200,align:'center'}
			  ]],
			  id:"testReload"
		  });
		  var $ = layui.$, active = {
