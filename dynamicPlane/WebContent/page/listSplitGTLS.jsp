...
layui.use(['element','table','jquery'], function(){
		  ...
		  table.render({
			  elem:'#page',
			  page:true,
			  url:'../GTLSServletSearch',
			  cols:[[
				  {	field:'fLID',title:'航班标识标签',width:200,sort: true,fixed:'left',align:'center'},
				  {	field:'fFID',title:'航班标识',width:200,align:'center'},
				  {	field:'fATT',title:'航班属性',width:200,align:'center'},						 
				  {	field:'gTNO',title:'登机门序号',width:150,align:'center'},		
				  {	field:'iD',title:'登机门唯一标识',width:150,align:'center'},
				  {	field:'cODE',title:'登机门编号',width:250,align:'center'},
				  {	field:'gTAT',title:'登机门属性',width:150,align:'center'},
				  {	field:'eSTR',title:'预计开始使用时间',width:200,align:'center'},						 
				  {	field:'eEND',title:'预计结束使用时间',width:200,align:'center'},		
				  {	field:'rEND',title:'实际结束使用时间',width:150,align:'center'},
				  {	field:'bTSC',title:'资源所属楼号',width:200,align:'center'}
			  ]],
			  id:"testReload"
		  });
		  var $ = layui.$, active = {
