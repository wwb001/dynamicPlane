...
layui.use(['element','table','jquery'], function(){
		  ...
		  table.render({
			  ...
			  cols:[[
				  ...
				  {	field:'fCES',title:'航班旅客值机预计开始时间',width:250,align:'center'},		
				  {	field:'fCEE',title:'航班旅客值机预计结束时间',width:150,align:'center'},
				  {	field:'cODE',title:'值机柜台编号',width:200,align:'center'},		
				  {	field:'cKAT',title:'值机柜台属性',width:200,align:'center'},
